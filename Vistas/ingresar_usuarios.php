...
if($boton=="ingresar"){
  ...
  $arrayDatos=array();
    ...
    &&$arrayDatos['contrasena']!=""&&$arrayDatos['rol']!="" ){
        $objTipo_usuario->constructor($arrayDatos);
        $respuesta= $objTipo_usuario->ingresar();
...
<body>
    <main>
        <div class="container">
            <h1 class="ingresar-title">Ingresar Usuario</h1>
            <div class="form-container">
                <form method="POST" action="sistema.php?r=ingresar_usuarios" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <select id="txtTipo_documento" name="txtTipo_documento" >
                                ...
                                <option value="CI" <?=$objTipo_usuario->tipo_documento == 'CI' ? 'selected' : ''?>>CI</option>
                                <option value="Pasaporte" <?=$objTipo_usuario->tipo_documento == 'Pasaporte' ? 'selected' : ''?>>Pasaporte</option>
                            </select>
                        ...
                        <div class="input-field col s6" > 
                            <select name="txtRol" required>
                                ...
                                <option value="administrador" <?=$objTipo_usuario->rol == 'administrador' ? 'selected' : ''?>>Administrador</option>
                                <option value="vendedor" <?=$objTipo_usuario->rol == 'vendedor' ? 'selected' : ''?>>Vendedor</option>
                                <option value="encargado" <?=$objTipo_usuario->rol == 'encargado' ? 'selected' : ''?>>Encargado</option>
                    ...
                    <div class="submit-buttons">
                        ...
                        <a href="sistema.php?r=tipo_usuario" class="btn red">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
